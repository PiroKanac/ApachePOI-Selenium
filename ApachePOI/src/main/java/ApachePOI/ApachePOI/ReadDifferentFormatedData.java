...
public class ReadDifferentFormatedData {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0; i < r; i++) {
			...
			for(int j = 0; j < c; j++)
			{
				...
				if(c11.getCellType() == 1) {
					System.out.print(c11.getStringCellValue() + "   ");
				}
				else if(c11.getCellType() == 0) {
					System.out.print(c11.getNumericCellValue() + "   ");
				}
				else if(c11.getCellType() == 4){
					System.out.print(c11.getBooleanCellValue() + "   ");
				}
				
			}
			System.out.println();
			
			//HSSFCell c1 = r1.getCell(0);   // get one cell
		/*	// get all data types
			if(c1.getCellType() == 1) {
